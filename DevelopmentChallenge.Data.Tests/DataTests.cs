    ...
    public class DataTests
    {
        ...
        public void TestResumenListaVacia()
        {
            Assert.AreEqual("<h1>Lista vacía de formas!</h1>",
                FormaGeometrica.Imprimir(Enumerable.Empty<IForma>().ToList(), new LenguajeCastellano()));
        }
        ...
        public void TestResumenListaVaciaFormasEnIngles()
        {
            Assert.AreEqual("<h1>Empty list of shapes!</h1>",
                FormaGeometrica.Imprimir(Enumerable.Empty<IForma>().ToList(), new LenguajeIngles()));
        }
        ...
        public void TestResumenListaConUnCuadrado()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(cuadrados, new LenguajeCastellano());
        ...
        public void TestResumenListaConMasCuadrados()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(cuadrados, new LenguajeIngles());
        ...
        public void TestResumenListaConMasTipos()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(formas, new LenguajeIngles());
        ...
        public void TestResumenListaConMasTiposEnCastellano()
        {
            ...
            var resumen = FormaGeometrica.Imprimir(formas, new LenguajeCastellano());
